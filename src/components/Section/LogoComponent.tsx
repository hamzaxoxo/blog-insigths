...
export default function LogoComponent() {
    return (
        <Container className="flex items-center justify-between sm:flex-row flex-col gap-5 text-zinc-500 p-20">
            ...
            </div>
            {
                logos.map((logo, index) => (
                    <div key={index} className="opacity-70 flex items-center justify-center sm:flex-row flex-col">
