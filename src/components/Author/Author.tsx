...
export default function Author({ image, name, role }: AuthorProps) {
  return (
    <div className="flex flex-col leading-none">
      <button className="flex flex-col items-center px-14 py-10 w-full bg-zinc-100 hover:bg-orange-50">
        <Image
          alt={name}
          loading="lazy"
          src={image}
          ...
          height={128}
        />
        <div className="mt-5 text-3xl font-bold tracking-tighter text-gray-800">
          {name}
        </div>
